            ...
            for elem in features:
                ...
                try:
                    ...
                    if num_views > 1 and elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.AGIBOT.value]:
                        ...
                        processed_item = "A multi-view video shows that a robot " + processed_item.lower() + " The video is split into four views: The top-left view shows the third-person agent view, the top-right view shows the third-person agent view from a different angle, the bottom-left view shows the wrist camera, and the bottom-right view is a black screen. The robot " + processed_item.lower()
                    else:
                    ...
                    if num_views > 1 and elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.AGIBOT.value]:
                        ...
                        item = "A multi-view video shows that a robot " + str(item).lower() + " The video is split into four views: The top-left view shows the third-person agent view, the top-right view shows the third-person agent view from a different angle, the bottom-left view shows the wrist camera, and the bottom-right view is a black screen. The robot " + str(item).lower()
                    else:
                        raise ValueError(f"Embodiment ID {elem['embodiment_id']} not supported.")
