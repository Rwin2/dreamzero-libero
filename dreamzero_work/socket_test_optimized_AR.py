...
class Args:
    ...
    embodiment_tag: str = "oxe_droid"  # Embodiment tag (e.g., oxe_droid, libero_sim, agibot)
...
def main(args: Args) -> None:
    ...
    if rank == 0:
        ...
        output_dir = os.path.join("output", f"real_world_eval_gen_{date_suffix}_{args.index}", checkpoint_name)
